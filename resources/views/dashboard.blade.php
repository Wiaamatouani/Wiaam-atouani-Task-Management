<x-app-layout>
    ...
    <body class="bg-black">
        <div class="flex h-screen bg-black">
            ...
            <main class="flex-1 ">
                <!-- Header -->
                <header class="flex p-2 pl-6 justify-between items-center ">
<div>             
                                ...
                                <div class=" gap-4 w-[73vw] p-3  flex flex-col ">
                                    ...
                                    <div class="   ">
                                        ...
                                        <div class=" grid-cols-1 flex items-center justify-center md:grid-cols-2 lg:grid-cols-3 gap-6">
                                                 ...
                                                 <!-- Time Tracker Card -->
    <div class="bg-[#111122]   rounded-xl w-[20vw] h-[35vh] p-2   shadow-lg justify-center flex flex-col items-center">
        <!-- Pause Button -->
        <h1 class="p-1 pb-3 font-bold text-stone-50"> One Click and start your Deadline</h1>
        ...
        <button
            id="toggleBtn"
            onclick="toggleTimer()"
            class="w-36 h-36 border-[#02098c] border-2 bg-[#02098c]/50 text-white rounded-full flex items-center justify-center focus:outline-none shadow-md"
        >
        ...
        function formatTime(seconds) {
            ...
            return [hrs, mins, secs]
                ...
                .join(':');
                                            ...
                                            <!-- Tasks Card -->
                                            <div class="bg-[#111122]   rounded-xl w-[25vw] h-[35vh] p-3 shadow-md overflow-hidden">
                                                ...
                                                <div class=" flex justify-center items-center gap-2  flex-col">
                                                    <div class="flex gap-2 flex-row">
                                                        <div class="bg-[#ff5353]/20  flex w-[11vw] p-3 border border-[#fc3c3c] rounded-2xl flex-col"> 
                                                            <div class="flex justify-between">
                                                                    ...
                                                                    <h1 class="font-mono">10:00 PM</h1>
                                                    ...
                                                    <div class="bg-white/10 flex w-[11vw]  border rounded-2xl p-3 flex-col">
                                                        <div class="flex justify-between">
                                          
                                                                <h1 class="font-mono">10:00</h1>
                                            ...
                                            <!-- Create Team Card -->
                                            <div class="bg-[#111122]   rounded-xl w-[25vw] h-[36vh]  p-3  shadow-md overflow-hidden">
                                                ...
                                                <div class="p-2 gap-2 flex flex-col">
                                                  ...
                                                  <div class="w-10vw flex flex-row  gap-3 items-center  bg-white/20 border rounded-2xl p-1 ">
